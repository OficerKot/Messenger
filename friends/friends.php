...
$all_users = User::getAllUsersExcept($_SESSION['id'], $conn); // Статический метод
?>
                ...
                <div class="users-list">
                    <?php if (count($all_users) > 0): ?>
                        <?php foreach ($all_users as $user_data): 
                            ...
                            $friend = new User($user_data['user_id'], $conn);
                            $friendship_status = $current_user->getFriendshipStatus($user_data['user_id'], $conn);
                        ?>
                            <div class="user-card">
                                <div class="user-info">
                                    <div class="user-name">
